...
This module provides utilities for visualization and plotting in reservoir
simulation. It includes functions for creating plots, generating visualizations,
and managing plot outputs.
...
- Figure management and optimization
